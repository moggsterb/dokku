    ...
    <div className='copy-wrapper'>
      <div className='copy'>
        ...
        <p>
          ...
          can be solved based on this method, helping to visually track
          progress.
        </p>
        ...
        <p>
          ...
          many cells in each row can be solved using this technique, giving
          users a live status of solvable cells.
        </p>

        <h3>3. Column Scanning</h3>
        <p>
          Simultaneously, <em>Dokku</em> applies the same process to columns,
          identifying solvable cells by checking the row and block constraints
          for each number. Users can track how many cells in each column are
          ready to be filled based on column scanning, combining information
          from all scanning strategies.
        </p>

        <h3>4. Single Candidate</h3>
        <p>
          While scanning rows, columns, and blocks, <em>Dokku</em> is also
          continuously identifying lone candidates—cells where only one number
          can fit based on the current state of the grid. These cells are
          immediately flagged as solvable, and users can see how many of these
          final candidates are available at any given moment.
        </p>
